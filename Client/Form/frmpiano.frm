...
Private Sub cbInstrument_Change()
...
Dim Note As Long
    ...
    If Note > 0 Then
        If Not Note = lNote And Note Then
            frmclient.wsclient.SendData "pplay/" & Note & "/" & cbInstrument.ListIndex
            'PlayNote Note
        End If
    End If
End Sub
...
Dim Note As Long
    Note = KeyMap(KeyCode)
    If Note > 0 Then
            frmclient.wsclient.SendData "splay/" & Note & "/" & cbInstrument.ListIndex
        'StopNote (Note)
    End If
End Sub
...
frmclient.wsclient.SendData "pplay/" & Index + 1 & "/" & cbInstrument.ListIndex
'PlayNote Index + 1
...
frmclient.wsclient.SendData "splay/" & Index + 1 & "/" & cbInstrument.ListIndex
